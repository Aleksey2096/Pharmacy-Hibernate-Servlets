...
public final class ProcessPaginatedPrescriptionRequestsCommand implements Command {
    /**
    ...
    public String execute(final HttpServletRequest request) {
        ...
        request.setAttribute(PRESCRIPTION_REQUESTS,
                service.readAllUnprocessedWithParameters(paginationObject, orderObject,
                        searchValue));
