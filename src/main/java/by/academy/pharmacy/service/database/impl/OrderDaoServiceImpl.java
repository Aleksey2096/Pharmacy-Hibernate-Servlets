...
import by.academy.pharmacy.converter.impl.OrderConverter;
...
public final class OrderDaoServiceImpl implements OrderDaoService {
    private final OrderDAO dao = new OrderDaoImpl();
    private final Converter<OrderEntity, OrderDTO> converter = new OrderConverter();
    ...
    public PaginationObject<OrderDTO> readAllWithParameters(
            final PaginationObject<OrderEntity> paginationObject, final OrderObject orderObject,
