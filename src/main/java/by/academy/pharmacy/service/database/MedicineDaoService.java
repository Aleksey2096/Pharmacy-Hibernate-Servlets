...
public interface MedicineDaoService extends DaoService<MedicineEntity, MedicineDTO, Long> {
    PaginationObject<MedicineDTO> readAllWithParameters(PaginationObject<MedicineEntity> pagination,
