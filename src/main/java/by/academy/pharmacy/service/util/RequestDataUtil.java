...
import static by.academy.pharmacy.entity.Constant.TRUE;
...
public final class RequestDataUtil {
    ...
    public static String getString(final String name, final HttpServletRequest request) {
    ...
    public static Short getShort(final String name, final HttpServletRequest request) {
        try {
    ...
    public static Integer getInteger(final String name, final HttpServletRequest request) {
        try {
    ...
    public static Long getLong(final String name, final HttpServletRequest request) {
        try {
    ...
    public static BigDecimal getBigDecimal(final String name, final HttpServletRequest request) {
        try {
    ...
    public static Country getCountry(final String name, final HttpServletRequest request) {
        try {
    ...
    public static Form getForm(final String name, final HttpServletRequest request) {
        try {
    ...
    public static Role getRole(final String name, final HttpServletRequest request) {
        try {
    ...
    public static Date getDate(final String name, final HttpServletRequest request) {
        try {
            return new SimpleDateFormat(DATE_FORMAT).parse(request.getParameter(name));
        } catch (NullPointerException | ParseException e) {
            return null;
        }
    }

    public static Boolean getBoolean(final String name, final HttpServletRequest request) {
        return request.getParameter(name).equalsIgnoreCase(TRUE);
    }

    public static void saveFile(final String path, final HttpServletRequest request,
    ...
    public static Integer getCurrentPage(final HttpServletRequest request) {
        return Optional.ofNullable(request.getParameter(CURRENT_PAGE)).map(Integer::parseInt)
    ...
    public static Integer getRecordsPerPage(final HttpServletRequest request) {
        return Optional.ofNullable(request.getParameter(RECORDS_PER_PAGE)).map(Integer::parseInt)
    ...
    public static OrderType getOrderType(final HttpServletRequest request) {
        return Optional.ofNullable(request.getParameter(ORDER_TYPE))
                .map(x -> OrderType.valueOf(x.toUpperCase())).orElse(OrderType.ASC);
    }
