...
public final class Constant {
     ...
     */
    public static final String PERSISTENCE_UNIT_PROPERTIES = "persistenceUnit.properties";
    /**
    ...
    public static final String JSP_ADMINISTRATOR_USERS_NEW_JSP = "/jsp/administrator/users/new.jsp";
    ...
    public static final String JSP_CLIENT_ORDERS_INDEX_JSP = "/jsp/client/orders/index.jsp";
    public static final String JSP_CLIENT_MEDICINES_INDEX_JSP = "/jsp/client/medicines/index.jsp";
    public static final String JSP_CLIENT_MEDICINE_PRODUCTS_INDEX_JSP
            = "/jsp/client/medicineProducts/index.jsp";
    public static final String JSP_CLIENT_ORDERS_CART_JSP = "/jsp/client/orders/cart.jsp";
    ...
    public static final String PRESCRIPTION_REQUEST_ID_DB = "prescription_request_id";
    ...
    public static final String MEDICINE_PRODUCT_ENTITY = "medicineProductEntity";
    ...
    public static final String ERROR_LOGIN_PASS_MESSAGE_KEY = "errorLoginPassMessageKey";
