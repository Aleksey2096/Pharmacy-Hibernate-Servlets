...
public class ProducerDaoServiceImplTest {
    private static final ProducerDaoService PRODUCER_DAO_SERVICE = new ProducerDaoServiceImpl();
    private static final Converter<ProducerEntity, ProducerDTO> CONVERTER = new ProducerConverter();

    @Test
    public void testCreate() throws SQLException {
        ProducerEntity producer = createTestProducer();
        ProducerDTO producerDTO = CONVERTER.convertToDto(producer);
        ProducerDTO createdProducerDTO = PRODUCER_DAO_SERVICE.create(producerDTO);
        ProducerEntity expectedProducer = CONVERTER.convertToEntity(createdProducerDTO);
    ...
    public void testReadById() throws SQLException {
        ...
        ProducerDTO producerDTO = PRODUCER_DAO_SERVICE.readById(actualProducer.getId());
        ProducerEntity expectedProducer = CONVERTER.convertToEntity(producerDTO);
        Calendar expectedDate = Calendar.getInstance();
        Calendar actualDate = Calendar.getInstance();
        expectedDate.setTime(expectedProducer.getCreationDate());
        actualDate.setTime(actualProducer.getCreationDate());
    ...
    public void testDeleteById() throws SQLException {
        ...
        ProducerEntity deletedProducer = selectProducerById(initialProducer.getId(),
                getConnection());
        assertAll(EQUALS_ALL_FIELDS, () -> assertNotNull(initialProducer.getId()),
    ...
    public void testReadAll() throws SQLException {
        ...
        List<ProducerEntity> expectedProducers = PRODUCER_DAO_SERVICE.readAll().stream()
